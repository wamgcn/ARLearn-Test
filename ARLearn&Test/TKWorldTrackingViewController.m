//
//  TKWorldTrackingViewController.m
//  ARLearn&Test
//
...
#import "TKWorldTrackingViewController.h"

@interface TKWorldTrackingViewController ()<ARSCNViewDelegate>
{
    ARSCNView *_scnView;
...
@implementation TKWorldTrackingViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    self.navigationItem.title = @"平面检测";
